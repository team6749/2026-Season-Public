...
public class Robot extends LoggedRobot {
  ...
  public Robot() {
    ...
    fmsTimer = new MatchTimer();
    robotContainer = new RobotContainer(fmsTimer);
  ...
  public void robotPeriodic() {
    ...
    fmsTimer.periodic();
    SmartDashboard.putNumber("matchTimer", fmsTimer.getMatchTime().in(Seconds));
